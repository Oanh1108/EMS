...
import sendEmail from "../cofig/nodemailer.js";

// Create a client to send and receive events
export const inngest = new Inngest({ id: "EMS_1008" });
...
// Cron: Check attendance at 11:30 AM Vietnam time (04:30 UTC) and email absent employees
const attendanceReminderCron = inngest.createFunction(
    { id: "attendance-reminder-cron", triggers: [{ cron: "TZ=Asia/Ho_Chi_Minh 30 4 * * *" }]}, // 04:30 UTC = 11:30 AM Vietnam time

    async ({ step }) => {
        // Step 1: Get today's date range (IST)
        const today = await step.run("get-today-date", () => {
            const startUTC = new Date(new Date().toLocaleDateString("en-CA", { timeZone: "Asia/Ho_Chi_Minh" }) + "T00:00:00+07:00")
