...
const Sidebar = () => {
    ...
    const sidebarContent = (
        <>
            ...
            {/* User profile card */}
            {userName && (
                <div className='mx-3 mt-4 mb-1 p-3 rounded-lg bg-white/30
                border border-white/4'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div className='min-w-0'>
                            ...
                            <p className='text-[11px] text-slate-500 truncate'>{role === "ADMIN" ? "Administrator"
                            : "Employee"}</p>
                        </div>
                    </div>
                </div>
            ...
            <div className='p-3 border-t border-white/6'>
                ...
                rounded-md text-[13px] font-medium text-slate-400 hover:text-rose-400
    ...
    return (
        ...
        backdrop-blur-sm z-40' onClick={() => setMobileOpen(false)} />}
            ...
            {/* Sidebar - desktop */}
            <aside className='hidden lg:flex flex-col h-full w-65 bg-linear-to-b
        from-slate-900 via-slate-900 to-slate-950 text-white shrink-0
        border-r border-white/4'>
            ...
            from-slate-900 via-slate-900 to-slate-950 text-white z-50 flex flex-col 
