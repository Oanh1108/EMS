...
const EmployeeForm = ({ initialData, onSuccess, onCancel }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const url = isEditMode ? `/employees/${initialData.id}` 
            : '/employees';
            ...
            border-b border-slate-100">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
                    ...
                    <div>
                        ...
                        <input name="basicSalary" type="number" step="0.01" min="0" required defaultValue={initialData?.basicSalary || 0} />
                    </div>
                    <div>
                        <label className="block mb-2">Allowances</label>
                        <input type="number" name="allowances" required step="0.01" min="0"
                            defaultValue={initialData?.allowances || 0} />
                    </div>
                    <div>
                        <label className="block mb-2">Deductions</label>
                        <input type="number" name="deductions" required step="0.01" min="0"
