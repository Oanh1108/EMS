    ...
    <div className='group relative card card-hover overflow-hidden'>
        ...
        from-slate-100 to-slate-50'>
            ...
            <div className='w-full h-full flex items-center justify-center'>
                {/* circle icons */}
                <div className='w-20 h-20 rounded-full bg-gradient-to-br from-indigo-100
        ...
        <div className='absolute top-3 gap-2 flex left-3'>
        ...
        {!employee.isDeleted && (
            <div className='absolute inset-0 bg-gradient-to-t from-indigo-700/20 
