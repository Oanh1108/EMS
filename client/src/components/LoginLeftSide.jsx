...
const LoginLeftSide = () => {
  return (
    <div className='bg-indigo-950 hidden md:flex w-1/2 relative overflow-hidden border-r border-slate-200'>
        ...
        <div className='relative z-10 flex flex-col items-start justify-center p-12 lg:p-20 w-full h-full'>
            ...
            text-white mb-6 leading-tight tracking-tight'>Employee Management System</h1>
            <br />
